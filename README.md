...
1. Clone the repository  
   ```bash
   git clone https://github.com/alireza-sharifat/duplicate-cleaner.git
...
Download the latest `DuplicateCleaner.exe` from the [Releases](https://github.com/alireza-sharifat/duplicate-cleaner/releases) section, double‑click, and you're ready to go.
...
- Reporting bugs or suggesting features via [Issues](https://github.com/alireza-sharifat/duplicate-cleaner/issues).  
